        ...
        return ( 
                <div className="videos">
                   ...
                   <iframe width="655" height="500" 
                    ...
                    />
                   <p>Link to Front-end: <a href={"https://github.com/jlangley3/gift_list_frontend"}>Front-End</a> ||  Link to Back-end: <a href={"https://github.com/jlangley3/gift_list_backend"}>Back-End</a></p>
                   <iframe width="655" height="500" 
                    ...
                    />
                    <p>Link to Front-end: <a href={"https://github.com/jlangley3/react_car_forum"}>Front-End</a> ||  Link to Back-end: <a href={"https://github.com/agdsarge/rails-car-forum"}>Back-End</a></p>
                   <ul>
                   ...
                   <iframe width="655" height="500" 
                    ...
                    />
                    <p>Link to Front-end: 
                            <a href={"https://github.com/jlangley3/bootcamp_fitness-frontend"}>Front-End</a> 
                            ||  Link to Back-end: 
                            <a href={"hhttps://github.com/jlangley3/bootcamp-fitness-backend"}>Back-End</a>
                    </p>
                   <ul>
                        <li>Link to Front-end: <a href={"https://github.com/jlangley3/bootcamp_fitness-frontend"}>GitHub</a></li>
                        <li>Link to Back-end: <a href={"https://github.com/jlangley3/bootcamp-fitness-backend"}>GitHub</a></li>
                   </ul>
                   <iframe width="655" height="500" 
